...
extern ncclGin_t* getNcclGin_v11_internal(ncclGin_v11_t* ncclGin_v11);
...
static void initPluginLibsOnceFunc() {
  ...
  ginPluginLibs[pluginCounter].ncclGin = getNcclGin_v11_internal(&ncclGinIbProxy);
  ginPluginLibs[pluginCounter].ncclGinPluginState = ncclGinPluginStateInitReady;
  ginPluginLibs[pluginCounter].ncclGinVersion = ncclGinVersion[2];
  ginPluginLibs[pluginCounter].ncclRma = nullptr;
  ginPluginLibs[pluginCounter].ncclRmaPluginState = ncclGinPluginStateDisabled;
  ginPluginLibs[pluginCounter].ncclGinVersion = 0;

  /* RCCL: temporary disabled till NCCL 2.30 merge
